		...
		<div class="col">
			<div class="graphina_card">
				<div class="graphina_card_body">
					...
					<a href="https://documentation.iqonic.design/graphina/gettings-started/" class="graphina_document_button" target="_blank" ><?php echo esc_html__( 'Documentation', 'graphina-charts-for-elementor' ); ?></a>
				</div>
			</div>
		</div>
		<div class="col">
