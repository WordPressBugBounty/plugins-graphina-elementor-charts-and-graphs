 ...
 * PieChart Class
 *
 * This class defines the Pie Chart widget for the Graphina plugin, integrating
 * with Elementor to provide a customizable Pie Chart based on ApexCharts.
 *
 * Product: Graphina - Elementor Charts and Graphs
 * Purpose: To allow users to create dynamic and interactive Pie Charts.
 */
class PieChart extends GraphinaApexChartBase {
	...
	public function get_title() {
		return __( 'Pie Chart', 'graphina-charts-for-elementor' );
	}
	 ...
	 * Get Chart Type
	 *
	 * Defines the type of chart this widget represents. In this case, 'pie'.
	 *
