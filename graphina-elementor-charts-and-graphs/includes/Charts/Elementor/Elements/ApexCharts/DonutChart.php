 ...
 * DonutChart Class
 *
 * This class defines the Donut Chart widget for the Graphina plugin, integrating
 * with Elementor to provide a customizable Donut Chart based on ApexCharts.
 *
 * Product: Graphina - Elementor Charts and Graphs
 * Purpose: To allow users to create dynamic and interactive Donut Charts.
 */
class DonutChart extends GraphinaApexChartBase {
	...
	public function get_title() {
		return __( 'Donut Chart', 'graphina-charts-for-elementor' );
	}
	...
	public function get_icon() {
		return 'graphina-apex-donut-chart';
	}

	/**
	 * Get Chart Type
	 *
	 * Defines the type of chart this widget represents. In this case, 'donut'.
	 *
     ...
     *
     * @param array $args Display parameters for the widget.
	...
	protected function graphina_prepare_chart_common_options( $settings, $chart_type, $element_id ) {
		...
		$chart_options['plotOptions'] = array(
			'pie' => array(
				'show'       => ! empty( $settings[ GRAPHINA_PREFIX . $chart_type . 'is_semi_circular_donut_chart' ] ) && $settings[ GRAPHINA_PREFIX . $chart_type . 'is_semi_circular_donut_chart' ] === 'yes' ? true : false,
				...
				'donut'      => array(
						...
						'valueInStringValue' => ! empty( $settings[ GRAPHINA_PREFIX . $chart_type . '_chart_label_pointer_number' ] ) ? $settings[ GRAPHINA_PREFIX . $chart_type . '_chart_label_pointer_number' ] : 0,
						'showlabel'          => ! empty( $settings[ GRAPHINA_PREFIX . $chart_type . '_chart_datalabels_format_showlabel' ] ) ? $settings[ GRAPHINA_PREFIX . $chart_type . '_chart_datalabels_format_showlabel' ] : 'no',
						'showValue'          => ! empty( $settings[ GRAPHINA_PREFIX . $chart_type . '_chart_datalabels_format_showValue' ] ) ? $settings[ GRAPHINA_PREFIX . $chart_type . '_chart_datalabels_format_showValue' ] : 'no',
						'value'              => array(
						...
						'total'              => array(
							'show'       => ! empty( $settings[ GRAPHINA_PREFIX . $chart_type . '_chart_datalabel_total_title_show' ] ) && $settings[ GRAPHINA_PREFIX . $chart_type . '_chart_datalabel_total_title_show' ] === 'yes' ? true : false,
							'showAlways' => ! empty( $settings[ GRAPHINA_PREFIX . $chart_type . '_chart_datalabel_total_title_always' ] ) && $settings[ GRAPHINA_PREFIX . $chart_type . '_chart_datalabel_total_title_always' ] === 'yes' ? true : false,
							'label'      => ! empty( $settings[ GRAPHINA_PREFIX . $chart_type . '_chart_datalabel_total_title' ] ) ? $settings[ GRAPHINA_PREFIX . $chart_type . '_chart_datalabel_total_title' ] : esc_html__( 'Total', 'graphina-charts-for-elementor' ),
							'fontFamily' => $settings[ GRAPHINA_PREFIX . $chart_type . '_chart_font_family' ],
							'fontWeight' => $settings[ GRAPHINA_PREFIX . $chart_type . '_chart_font_weight' ],
							'color'      => ! empty( $settings[ GRAPHINA_PREFIX . $chart_type . '_chart_datalabel_font_color' ] ) ? strval( $settings[ GRAPHINA_PREFIX . $chart_type . '_chart_datalabel_font_color' ] ) : '#000000',
						),
					),
				),
