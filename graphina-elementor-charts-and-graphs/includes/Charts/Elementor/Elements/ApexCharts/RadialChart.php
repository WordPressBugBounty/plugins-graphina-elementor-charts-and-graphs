 ...
 * RadialChart Class
 *
 * This class defines the Radial Chart widget for the Graphina plugin, integrating
 * with Elementor to provide a customizable Radial Chart based on ApexCharts.
 *
 * Product: Graphina - Elementor Charts and Graphs
 * Purpose: To allow users to create dynamic and interactive Radial Charts.
 */
class RadialChart extends GraphinaApexChartBase {
	...
	public function get_title() {
		return __( 'Radial Chart', 'graphina-charts-for-elementor' );
	}
	 ...
	 * Get Chart Type
	 *
	 * Defines the type of chart this widget represents. In this case, 'radial'.
	 *
	...
	protected function register_controls() {
		...
		$controls->graphina_common_chart_setting( $this, $chart_type,  true, true, false, false);
	...
	protected function graphina_prepare_chart_common_options($settings, $chart_type, $element_id)
	{
		...
		$categories = $gradient_new = $second_gradient = $fill_pattern = $gradient = array();
					...
					'options'    => array(
						...
						'dataLabels' => array(
							...
							'style'      => array(
								...
								'colors'     => [! empty($settings[GRAPHINA_PREFIX . $chart_type . '_chart_datalabel_background_show_tablet']) && $settings[GRAPHINA_PREFIX . $chart_type . '_chart_datalabel_background_show_tablet'] === 'yes' ? $settings[GRAPHINA_PREFIX . $chart_type .  '_chart_datalabel_font_color_1_tablet'] : $settings[GRAPHINA_PREFIX . $chart_type . '_chart_datalabel_font_color_tablet'] ?? (! empty($settings[GRAPHINA_PREFIX . $chart_type . '_chart_datalabel_background_show' ]) && $settings[GRAPHINA_PREFIX . $chart_type . '_chart_datalabel_background_show' ] === 'yes' ? $settings[ GRAPHINA_PREFIX . $chart_type .  '_chart_datalabel_font_color_1' ] : $settings[ GRAPHINA_PREFIX . $chart_type . '_chart_datalabel_font_color' ])]
							),
							'background' => array(
					...
					'options'    => array(
						...
						'dataLabels' => array(
							...
							'style'      => array(
								...
								'colors'     => [! empty($settings[GRAPHINA_PREFIX . $chart_type . '_chart_datalabel_background_show_mobile']) && $settings[GRAPHINA_PREFIX . $chart_type . '_chart_datalabel_background_show_mobile'] === 'yes' ? $settings[GRAPHINA_PREFIX . $chart_type .  '_chart_datalabel_font_color_1_mobile'] : $settings[GRAPHINA_PREFIX . $chart_type . '_chart_datalabel_font_color_mobile'] ?? (! empty($settings[GRAPHINA_PREFIX . $chart_type . '_chart_datalabel_background_show' ]) && $settings[GRAPHINA_PREFIX . $chart_type . '_chart_datalabel_background_show' ] === 'yes' ? $settings[ GRAPHINA_PREFIX . $chart_type .  '_chart_datalabel_font_color_1' ] : $settings[ GRAPHINA_PREFIX . $chart_type . '_chart_datalabel_font_color' ])]
							),
							'background' => array(
		...
		if ($settings[GRAPHINA_PREFIX . $chart_type . '_chart_angle'] === 'circle') {
			$start_angle = 0;
			$end_angle   = 360;
		} elseif ($settings[GRAPHINA_PREFIX . $chart_type . '_chart_angle'] === 'semi_circle') {
			$start_angle = -90;
			$end_angle   = 90;
		} else {
			$start_angle = $settings[GRAPHINA_PREFIX . $chart_type . '_chart_start_angle'];
			$end_angle   = $settings[GRAPHINA_PREFIX . $chart_type . '_chart_end_angle'];
		}
		$chart_options['plotOptions'] = array(
			'radialBar' => array(
				'startAngle' => intval($start_angle),
				'endAngle'   => intval($end_angle),
				'hollow'     => array(
					'size' => (70 - intval($settings[GRAPHINA_PREFIX . $chart_type . '_chart_line_width'])),
				),
				'dataLabels' => array(
					'show'    => $settings[GRAPHINA_PREFIX . $chart_type . '_chart_datalabel_show'] === 'yes',
					'name'    => array(
						'show'       => ! empty($settings[GRAPHINA_PREFIX . $chart_type . '_chart_datalabel_total_title_show']) && $settings[GRAPHINA_PREFIX . $chart_type . '_chart_datalabel_total_title_show'] === 'yes',
					...
					'value'   => array(
						...
						'fontSize'   => ! empty($settings[GRAPHINA_PREFIX . $chart_type . '_chart_font_size']['size']) ? ((int) $settings[GRAPHINA_PREFIX . $chart_type . '_chart_font_size']['size'] + 2) . $settings[GRAPHINA_PREFIX . $chart_type . '_chart_font_size']['unit'] : '12px',
					),
					'total'   => array(
						'fontFamily' => $settings[GRAPHINA_PREFIX . $chart_type . '_chart_font_family'],
						'fontWeight' => $settings[GRAPHINA_PREFIX . $chart_type . '_chart_font_weight'],
						'color'      => ! empty($settings[GRAPHINA_PREFIX . $chart_type . '_chart_datalabel_font_color']) ? $settings[GRAPHINA_PREFIX . $chart_type . '_chart_datalabel_font_color'] : '#000000',
						'fontSize'   => ! empty($settings[GRAPHINA_PREFIX . $chart_type . '_chart_font_size']['size']) ? $settings[GRAPHINA_PREFIX . $chart_type . '_chart_font_size']['size'] . $settings[GRAPHINA_PREFIX . $chart_type . '_chart_font_size']['unit'] : '12px',
						'show'       => $settings[GRAPHINA_PREFIX . $chart_type . '_chart_datalabel_show'] === 'yes',
						'label'      => ! empty($settings[GRAPHINA_PREFIX . $chart_type . '_chart_datalabel_total_title']) ? $settings[GRAPHINA_PREFIX . $chart_type . '_chart_datalabel_total_title'] : 'Total',
					),
				...
				'track'      => array(
					...
					'strokeWidth' => $settings[GRAPHINA_PREFIX . $chart_type . '_chart_track_width'],
					'opacity'     => $settings[GRAPHINA_PREFIX . $chart_type . '_chart_track_opacity'],
				),
			),
		);
		...
		if (! empty($settings[GRAPHINA_PREFIX . $chart_type . '_chart_track_color_enable']) && $settings[GRAPHINA_PREFIX . $chart_type . '_chart_track_color_enable']) {
			$chart_options['plotOptions']['radialBar']['track']['background'] = $settings[GRAPHINA_PREFIX . $chart_type . '_chart_track_color'] ? $settings[GRAPHINA_PREFIX . $chart_type . '_chart_track_color'] : '#808080';
		}
		$chart_options['stroke']['lineCap']  = $settings[GRAPHINA_PREFIX . $chart_type . '_chart_is_stroke_rounded'] === 'yes' ? 'round' : '';
