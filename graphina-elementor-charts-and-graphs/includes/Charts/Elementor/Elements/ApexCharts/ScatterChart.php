 ...
 * ScatterChart Class
 *
 * This class defines the Scatter Chart widget for the Graphina plugin, integrating
 * with Elementor to provide a customizable Scatter Chart based on ApexCharts.
 *
 * Product: Graphina - Elementor Charts and Graphs
 * Purpose: To allow users to create dynamic and interactive Scatter Charts.
 */
class ScatterChart extends GraphinaApexChartBase {
	...
	public function get_title() {
		return __( 'Scatter Chart', 'graphina-charts-for-elementor' );
	}
	 ...
	 * Get Chart Type
	 *
	 * Defines the type of chart this widget represents. In this case, 'scatter'.
	 *
	...
	protected function register_controls() {
		...
		$controls->graphina_common_chart_setting( $this, $chart_type,  false, true, false, false, true );
	...
	protected function graphina_prepare_chart_common_options($settings, $chart_type, $element_id)
	{
		...
		$chart_options = array(
			...
			'tooltip' => [
				'enabled' 	=> $settings[GRAPHINA_PREFIX . $chart_type . '_chart_tooltip'] === 'yes' ? true : false,
				'intersect' => ! empty($settings[GRAPHINA_PREFIX . $chart_type . '_chart_tooltip_shared']) && $settings[GRAPHINA_PREFIX . $chart_type . '_chart_tooltip_shared'] === 'yes' ? false : true,
				'shared' 	=> ! empty($settings[GRAPHINA_PREFIX . $chart_type . '_chart_tooltip_shared']) && $settings[GRAPHINA_PREFIX . $chart_type . '_chart_tooltip_shared'] === 'yes' ? true : false,
				'theme' 	=> $settings[GRAPHINA_PREFIX . $chart_type . '_chart_tooltip_theme'],
				'style' => [
					'fontSize' 		=> ! empty( $settings[GRAPHINA_PREFIX . $chart_type . '_chart_font_size']['size'] ) ? $settings[GRAPHINA_PREFIX . $chart_type . '_chart_font_size']['size'] . $settings[GRAPHINA_PREFIX . $chart_type . '_chart_font_size']['unit'] : '',
		...
		if ( ! empty( $settings[ GRAPHINA_PREFIX . $chart_type . '_chart_tooltip_shared' ] ) && $settings[ GRAPHINA_PREFIX . $chart_type . '_chart_tooltip_shared' ] === 'yes' && ! empty( $tooltip_series ) ) {
		...
		$chart_options['markers'] = array(
			'size' => $settings[GRAPHINA_PREFIX . $chart_type . '_chart_scatter_width'],
		);
