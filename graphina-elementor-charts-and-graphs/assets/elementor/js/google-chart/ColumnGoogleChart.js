...
export default class ColumnChart extends GraphinaGoogleChartBase {
    // Setup handlers for Column Chart
    setUpChartsHandler() {
        this.chartHandlers = {
            column_google: (element) => this.observeChartElement(element, 'ColumnChart'),
        };
    }
