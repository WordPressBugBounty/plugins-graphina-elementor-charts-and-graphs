...
export default class LineChart extends GraphinaGoogleChartBase {
    // Setup handlers for Line Chart
    setUpChartsHandler() {
        this.chartHandlers = {
            line_google: (element) => this.observeChartElement(element, 'LineChart'),
        };
    }
    ...
    // Customize chart options for Line Charts (if needed)
