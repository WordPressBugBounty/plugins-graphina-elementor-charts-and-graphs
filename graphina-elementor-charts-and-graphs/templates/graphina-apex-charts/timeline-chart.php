...
<script>
    (function($) {
        ...
        $(document).ready(function() {
            if (window.graphinaTimelineChart && typeof window.graphinaTimelineChart.observeChartElement === 'function') {
                window.graphinaTimelineChart.observeChartElement($('.graphina-elementor-chart[data-element_id="<?php echo esc_js( $element_id ); ?>"]'), 'timeline');
            }
        });
    })(jQuery);
</script>