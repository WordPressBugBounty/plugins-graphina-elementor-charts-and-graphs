...
<script>
    (function($) {
        ...
        $(document).ready(function() {
            if (window.graphinaBubbleChart && typeof window.graphinaBubbleChart.observeChartElement === 'function') {
                window.graphinaBubbleChart.observeChartElement($('.graphina-elementor-chart[data-element_id="<?php echo esc_js( $element_id ); ?>"]'), 'bubble');
            }
        });
    })(jQuery);
</script>