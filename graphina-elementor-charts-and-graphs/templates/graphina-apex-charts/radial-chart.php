...
<script>
    (function($) {
        ...
        $(document).ready(function() {
            if (window.graphinaRadialChart && typeof window.graphinaRadialChart.observeChartElement === 'function') {
                window.graphinaRadialChart.observeChartElement($('.graphina-elementor-chart[data-element_id="<?php echo esc_js( $element_id ); ?>"]'), 'radial');
            }
        });
    })(jQuery);
</script>