...
<script>
    (function($) {
        ...
        $(document).ready(function() {
            if (window.graphinaHeatmapChart && typeof window.graphinaHeatmapChart.observeChartElement === 'function') {
                window.graphinaHeatmapChart.observeChartElement($('.graphina-elementor-chart[data-element_id="<?php echo esc_js( $element_id ); ?>"]'), 'heatmap');
            }
        });
    })(jQuery);
</script>