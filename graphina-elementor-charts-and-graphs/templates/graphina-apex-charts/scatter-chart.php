...
<script>
    (function($) {
        ...
        $(document).ready(function() {
            if (window.graphinaScatterChart && typeof window.graphinaScatterChart.observeChartElement === 'function') {
                window.graphinaScatterChart.observeChartElement($('.graphina-elementor-chart[data-element_id="<?php echo esc_js( $element_id ); ?>"]'), 'scatter');
            }
        });
    })(jQuery);
</script>