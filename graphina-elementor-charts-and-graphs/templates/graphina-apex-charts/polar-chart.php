...
<script>
    (function($) {
        ...
        $(document).ready(function() {
            if (window.graphinaPolarChart && typeof window.graphinaPolarChart.observeChartElement === 'function') {
                window.graphinaPolarChart.observeChartElement($('.graphina-elementor-chart[data-element_id="<?php echo esc_js( $element_id ); ?>"]'), 'polar');
            }
        });
    })(jQuery);
</script>