...
<script>
    (function($) {
        ...
        $(document).ready(function() {
            if (window.graphinaCandleChart && typeof window.graphinaCandleChart.observeChartElement === 'function') {
                window.graphinaCandleChart.observeChartElement($('.graphina-elementor-chart[data-element_id="<?php echo esc_js( $element_id ); ?>"]'), 'candle');
            }
        });
    })(jQuery);
</script>