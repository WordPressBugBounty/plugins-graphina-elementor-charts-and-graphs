...
?>
<div class="chart-box">
    <div class="graphina-elementor-chart <?php echo isset($common_filter_class) ? esc_attr($common_filter_class) : ''; ?>"
...
<script>
    (function($) {
        ...
        $(document).ready(function() {
            if (window.graphinaMixedChart && typeof window.graphinaMixedChart.observeChartElement === 'function') {
                window.graphinaMixedChart.observeChartElement($('.graphina-elementor-chart[data-element_id="<?php echo esc_js( $element_id ); ?>"]'), 'mixed');
            }
        });
    })(jQuery);
</script>