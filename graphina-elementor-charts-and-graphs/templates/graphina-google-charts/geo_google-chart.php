...
?><div class="chart-box">
	...
	<div class="graphina-google-chart <?php echo esc_attr($common_filter_class); ?>"
		...
		data-chart_type_static="GeoChart"
...
<script>
    (function($) {
        ...
        $(document).ready(function() {
            if (window.graphinaGoogleGeoChart && typeof window.graphinaGoogleGeoChart.observeChartElement === 'function') {
                window.graphinaGoogleGeoChart.observeChartElement($('.graphina-google-chart[data-element_id="<?php echo esc_js( $element_id ); ?>"]'), 'GeoChart');
            }
        });
    })(jQuery);
</script>