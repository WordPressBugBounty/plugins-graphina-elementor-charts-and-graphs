...
<script>
    (function($) {
        ...
        $(document).ready(function() {
            if (window.graphinaGoogleOrgChart && typeof window.graphinaGoogleOrgChart.observeChartElement === 'function') {
                window.graphinaGoogleOrgChart.observeChartElement($('.graphina-google-chart[data-element_id="<?php echo esc_js( $element_id ); ?>"]'), 'OrgChart');
            }
        });
    })(jQuery);
</script>