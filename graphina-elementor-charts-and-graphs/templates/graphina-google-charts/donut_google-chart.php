...
?><div class="chart-box">
	...
	<div class="graphina-google-chart <?php echo esc_attr($common_filter_class); ?>"
		...
		data-chart_type_static="DountChart"
...
<script>
    (function($) {
        ...
        $(document).ready(function() {
            if (window.graphinaGoogleDonutChart && typeof window.graphinaGoogleDonutChart.observeChartElement === 'function') {
                window.graphinaGoogleDonutChart.observeChartElement($('.graphina-google-chart[data-element_id="<?php echo esc_js( $element_id ); ?>"]'), 'PieChart');
            }
        });
    })(jQuery);
</script>