...
?><div class="chart-box">
	...
	<div class="graphina-google-chart <?php echo esc_attr($common_filter_class); ?>"
		...
		data-chart_type_static="BarChart"
...
<script>
    (function($) {
        ...
        $(document).ready(function() {
            if (window.graphinaGoogleBarChart && typeof window.graphinaGoogleBarChart.observeChartElement === 'function') {
                window.graphinaGoogleBarChart.observeChartElement($('.graphina-google-chart[data-element_id="<?php echo esc_js( $element_id ); ?>"]'), 'BarChart');
            }
        });
    })(jQuery);
</script>