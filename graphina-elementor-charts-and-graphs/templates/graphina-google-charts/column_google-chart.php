...
<script>
    (function($) {
        ...
        $(document).ready(function() {
            if (window.graphinaGoogleColumnChart && typeof window.graphinaGoogleColumnChart.observeChartElement === 'function') {
                window.graphinaGoogleColumnChart.observeChartElement($('.graphina-google-chart[data-element_id="<?php echo esc_js( $element_id ); ?>"]'), 'ColumnChart');
            }
        });
    })(jQuery);
</script>