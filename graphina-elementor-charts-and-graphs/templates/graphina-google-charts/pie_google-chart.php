...
<div class="chart-box">
	...
	<div class="graphina-google-chart <?php echo esc_attr($common_filter_class); ?>"
		...
		data-chart_type_static="PieChart"
...
<script>
    (function($) {
        ...
        $(document).ready(function() {
            if (window.graphinaGooglePieChart && typeof window.graphinaGooglePieChart.observeChartElement === 'function') {
                window.graphinaGooglePieChart.observeChartElement($('.graphina-google-chart[data-element_id="<?php echo esc_js( $element_id ); ?>"]'), 'PieChart');
            }
        });
    })(jQuery);
</script>